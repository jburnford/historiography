...
## Requested roster corrections and medical/geographical expansion — revision 1.121, 2026-09-18

User prioritized thin medical/health history and historical geography, then requested Paul E. Lovejoy, Geoff Eley in New social history, E. A. Wrigley in Economic history, Wallerstein as a world-systems practitioner and Maxine Berg in consumption. Applied the five named-person corrections in production revision **1.121**: Eley and coauthor Keith Nield join `social`; Wrigley joins `economic`; Wallerstein's `dependency` role becomes `historian` (the existing practitioner category), with prior world-systems strand and qualifications retained; new shared person Paul E. Lovejoy joins `africanhist` and `atlantic`; Berg and coeditor Helen Clifford join `consumption`. Existing identities and other field contexts survive. Lovejoy is distinct from Arthur O. Lovejoy; no full person node added.

Production totals: **126 nodes (75 groups, 51 people), 765 edges, 846 sources, 833 shared people, 738 strands, 1,318 roster selections and 13 pathways.** Seven roster additions, five strands, three new people, five sources and one role/context correction; no new influence edges. Claim/journal catalogues, pathways, earlier edges and unrelated records remain unchanged. Evidence scopes: Eley/Nield 1980 metadata, Lovejoy 1997 indexed author abstract and identity profile, Wrigley institutional account, Berg/Clifford 1999 institutional bibliography. No full-work reading or automatic post-2000 acceptance. See `data/production-batches/roster-corrections-1.121/README.md` and acceptance record; exact reconstruction via `python3 scripts/apply_roster_corrections.py --check`, using `drafts/historiography-1920-2000.v1.120.json`.

The larger continuation is staged in `data/extension-2026/health-geography-05/README.md`: sixteen works, twenty-four people, eighteen substantive proposals (eight selected-passage, five description, five abstract), twenty-seven authorship credits and two version links; **47 claims, all needs_review**. Five medical works cover Rogaski, Cueto/Palmer, Cooper Owens, McCallum and Wynter/Campbell/Chaney/Marks; six geographical works cover Harris, McKittrick, Gregory/Healey, Machado/Gomes, Silveira and Legg/Ding/Ferretti/Morin/Novaes. Three Lovejoy works and two Eley works support their further development. Four concrete entry drafts: medicalhistory, spatialhistory, social and a full Lovejoy entry. These are proposed extensions, not production imports or complete field reviews through 2026.

Retain all coauthors, Portuguese-language evidence, regional distinctions, source failures and limited reading scopes. McKittrick's 2020 reprint is not a new 2020 intervention; Lovejoy's later Transformations edition is not the original 1983 work. Cueto/Palmer's 2014 publisher/2015 bibliographic date variation remains explicit. Recent Wynter et al. authorship follows the version of record. Medical topics are historiography, not clinical advice. No demographic or QID inference.

`coverage-current.json` carries forward 75 topics/37 discovery candidates and their original ledger rows. Baseline is pinned to 1.120; `production-crosswalk.json` links the now-accepted Lovejoy/Nield identities without accepting the research claims. Rebuild with `python3 scripts/build_priority_research.py`; `--check` verifies contract, source hashes, prior packet preservation and exact output. Twenty-five focused research/roster/graph/people tests passed; graph validation zero errors/four unchanged warnings.

Next: review and adapt the medical/geographical drafts for acceptance, including source-ID mapping and rebasing onto 1.121; recover body texts and independent regional/language surveys, especially 2020–2026 gaps. The prior digital/web rotation was interrupted by these user priorities. Discovery captures remain in `raw/digital-leads.json`; Putnam's full body was NOT recovered (403), and Gallini/Noiret's retrieved Spanish PDF has no assembled claims yet. Resume that balanced rotation after addressing these drafts rather than treating any field as complete. **Fable owns the website rebuild; no site/docs edits or deployment here. OpenAlex remains paused.**

## Evidence recovery and Spanish-language regional review — batch 04, 2026-09-18

User said continue. Completed `data/extension-2026/evidence-recovery-04/README.md`, an additive **cumulative overlay of batch 03**, not a separate set to sum/concatenate. Four new works (Plumwood review 2007, Gallini 2009, Watts 2013, Whyte 2017), eight new passage-supported substantive proposals, four author credits and one manuscript-version link. Added selected-body evidence to the existing Kearns claim without changing its ID/statement/endpoints/year/review state; original abstract citation and earlier record remain. Cumulative: eleven works, 31 claims (nineteen substantive, eleven authorship, one version); seventeen substantive proposals have selected-passage evidence. All remain needs_review/staging, no production imports.

Plumwood's review establishes a specific 2007 reception of Rose, not a body-text check of Rose's book. Rose's author-profile CV and Plumwood corroborate the working subtitle Ethics for Decolonisation; preserve publisher variant and unchecked physical title page. Original Rose claim and the Nature 2026 indexed-only claim are unchanged. Watts pp. 21–24 supports bounded Place-Thought and agency proposals; Davis/Todd p. 767 note 7 and pp. 769–770 explicitly use her work. This uptake dates to 2017, not 2013, and preserves both coauthors. Whyte's author-uploaded February 2017 manuscript recovered after MSU timeout/certificate failures; version is separate, final publication wording uncollated. Never use final ELN pp. 153–162 as manuscript locators.

Gallini's Spanish original, Nómadas 30 (2009), pp. 94–96, supports regional-method and archive/research-cost proposals. English statements are research paraphrases; her Colombian emphasis and non-exhaustive 2009 scope survive. Four new local people (Plumwood, Watts, Whyte, Gallini), no demographic or external-authority acceptance. Named original-language and Indigenous-theory recovery narrows specific selection gaps, but no completed regional/representation census is claimed.

`review-actions.json` stores complete earlier Kearns/Rose records and hashes; other batch-03 entities/claims/sources remain exact. `coverage-current.json` derives from batch 03, retaining 75 topics/37 candidates and original ledger rows. Rebuild with `python3 scripts/build_evidence_recovery.py`, check with `--check`; seven focused tests in `tests/test_evidence_recovery.py` pass. Contract, source hashes, exact rebuild, prior packet and production/pathway preservation pass. Graph remains 1.120, 126 nodes/765 edges/841 sources/830 people; zero structural errors/four existing warnings. No website edits, OpenAlex, deployment or full book-PDF retention.

**Next rotate to digital/web history**, using the concrete Spanish-language lead Gallini/Serge Noiret, “La historia digital en la era del Web 2.0. Introducción al dossier Historia digital,” Historia Crítica 43 (2011), 16–37. Title/metadata surfaced; body not yet read. Combine with the existing Leon/Gallon/Putnam recovery and recent web-history methods/access inequality. Keep environmental follow-ups queued: Rose body/title page, full Nature 2026 debate, Whyte final-text collation, regional 2020–2026/African/Pacific surveys and Bawaka Country collective-author modeling. Do not keep expanding only this accessible environmental cluster.

## Post-2000 extension resumed: environmental and Indigenous batch 03 — 2026-09-18

User asked to continue building forward from 2000 to 2026 using the plans. Completed `data/extension-2026/earth-indigenous-03/README.md`: seven selected works (Rose 2004, Cruikshank 2005, Morrison 2015, Davis/Todd 2017, Sivasundaram 2024, Kearns 2025, unsigned Nature editorial 8 September 2026). Eleven substantive proposals: eight selected-passage checks, one abstract, one description and one indexed excerpt. Seven separate authorship credits. All staging/needs_review; zero production imports. Ten people: reuse Cruikshank, Angela Sidney, Kitty Smith and Annie Ned; six new local candidates, no external authority or gender assertions. Cruikshank p. 8 explicitly acknowledges the three elders; do not erase their contributions or invent 2005 encounters/book authorship.

`coverage-current.json` now indexes all 75 current topics and all 37 original discovery candidates, preserving each original ledger row. New racial_formation/intersectionality remain unresearched after 2000; old combined gender scope is not automatically inherited. Earlier 73-topic ledgers/manifests remain frozen. Plan/index updated to current baseline and imported promotion status. No field claimed complete; the new view is an index of partial research, not a merged catalogue of every staging claim.

Evidence traps: Cruikshank's work is 2005, not later ebook dates. Morrison's author-uploaded printed pages are Seminar 673 (2015), NOT the Germanic-studies journal incorrectly matched by ResearchGate. Rose subtitle variant remains unresolved and body PDF retrieval failed. Kearns abstract recovered from publisher-supplied ResearchGate text after MDPI 429. Nature 2026 direct page supplied a preview; fuller indexed text remains indexed-only. IUGS statement is dated 20 March 2024 (webpage 21 March): formal-epoch rejection does not terminate historiographical usage. North American colonial dating proposals are attributed positions, not settled geology. Source captures/hash/locators and failed access records retained; no raw whole book PDFs.

Rebuild/check: `python3 scripts/build_earth_indigenous_batch.py` and `--check`; five focused tests in `tests/test_earth_indigenous_batch.py`. Contract, exact rebuild and incoming graph/pathway/prior research hashes pass. Graph remains 1.120: 126 nodes, 765 edges, 841 sources, 830 people; structural validator zero errors/four existing warnings. Fable concurrently changed site/docs assets; preserved observed baseline hashes and reports those separately, without changing them or falsely claiming website preservation. This turn edits no website source/build. OpenAlex paused; no deployment.

Next: body-text/reception recovery for Rose/Kearns/2026 discussion, Whyte's 2017 programme, Indigenous bibliography contributors including Watts/Bawaka Country, and independent African/Latin American/Pacific/relevant-language surveys. Representation review is incomplete with explicit English-access/regional gaps; no production-ready certification. Continue other existing-topic/new-field work and pre-2000 omissions rather than over-expanding this accessible cluster. Assembly UTC 19 September remains local 18 September; cutoff unchanged.

## Gender, racial formation and intersectional analysis separated — revision 1.120

User approved standalone gender/racial/queer inquiry connected through intersectional analysis. Production `gender` now labels Gender history (Research field), `racial_formation` is a new standalone theoretical programme, `intersectionality` is a new connecting Method / approach; existing `queer` Sexuality & queer history remains independent. Women’s and Black history remain separate. Moved Omi/Winant and Crenshaw roster records and two strands intact; top-level strand_redirects maps gender/race → racial_formation/race and gender/intersection → intersectionality/intersection.

Reviewed all old gender-incident edges; kept gender-specific IDs and cleaned old combined-entry qualifications. edge_116 narrowed to Scott’s experience/category critique; new edge_765 separately states Crenshaw’s single-axis critique. New edge_762/763 are undirected conceptual comparisons connecting intersectionality to gender/racial formation (no invented Crenshaw–Omi borrowing). edge_764 is Cohen’s bounded critique targeting queer/intersectional_critique. Cathy J. Cohen added as shared person cathy_j_cohen and in queer/intersectionality rosters, not a full node or QID match. Cohen’s 1997 pp. 437–442 checked via OCR, p. 441 visually; she explicitly invokes intersectional analysis and names Crenshaw. Crenshaw 1989 pp. 139–140 and Omi/Winant course extract pp. 1–3 checked, retaining edition uncertainty. Raw PDF remains temporary, URL/hash/reading notes retained.

Totals: **126 nodes (75 groups, 51 people), 765 teaching edges, 841 sources, 830 people, 733 strands**. Claim catalogue adds three works/twelve claims (four authorship/eight substantive), now ten works/47 claims. All previous claims, entities, source witnesses and journal catalogue preserved, including incoming witness hash additions and the other session’s ontology validator edits. Captured actual incoming baseline in drafts/historiography-1920-2000.v1.119.json, rather than overwriting it with the earlier 1.119 acceptance state. Pathway snapshot drafts/seminar-pathways.before-1.120.json; main pathway now includes the separate entries and replaces its obsolete split question.

`data/production-batches/gender-split-1.120/README.md`, EVIDENCE.md and acceptance.json contain changes and Fable handoff. Reproduce with scripts/split_gender_fields.py against the preserved 1.119 state; audit_gender_split.py verifies exact reconstruction and preservation. Twenty-three split/graph/people tests pass; zero structural errors/four unchanged warnings. **No website source or docs build edits this turn; Fable owns the rebuild.** Other session’s public-build edits left intact. Old research ledgers still describe their frozen 73-topic baseline; new entries need 2001–2026 research. OpenAlex paused; no deployment.
