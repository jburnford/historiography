...
**Current acceptance update:** [production revision 1.122](../production-batches/extension-1.122/README.md) accepts the nine-work medical/geography subset from candidate 06 after Fable's website integration passed verification. Candidate 06 and batch 05 remain frozen historical staging records; their selected claims now have separate production acceptance records. Other research packets, including digital/web batch 07, remain unaccepted. The local build includes the exact archived 2000 view; no remote deployment was performed.
...
| Artifact | Scope |
| --- | --- |
| [Digital/web batch 07](digital-web-07/README.md) | Six new works/thirteen new historical proposals; four exact older claims retained. Two separate entry drafts, coauthor credits and publication/reception distinctions; latest coverage view, all still staging. Includes a checked June 2026 archival-theory intervention. |
